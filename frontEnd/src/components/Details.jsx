        ...
        <div className="flex items-center justify-center p-5">
          <div className="px-6 py-8 border-2 shadow-lg border-white/20 bg-white/10 rounded-3xl backdrop-blur-md">
            ...
            <div className="mb-3">
              ...
              <select
                className="w-full px-4 py-3 text-white bg-black rounded-xl placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-sky-400 backdrop-blur-sm"
            ...
            <div className="mb-3">
              ...
              <textarea
                rows="3"
                placeholder="A small intro about yourself..."

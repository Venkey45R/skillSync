  ...
  const handleSubmit = () => {
    if (company === "" || bio === "" || locations === "") {
      ...
      if (!id) {
        ...
        axios
          .post(`${API_BASE}/company`, { id, company, bio, locations, contact })
          .then((res) => {
            if (res.data === "success") {
              confetti({
                particleCount: 500,
      ...
      <div className="flex items-center justify-center p-5">
        <div className="px-6 py-8 border-2 shadow-lg min-w-80 lg:min-w-md border-white/20 bg-white/10 rounded-3xl backdrop-blur-md">
          ...
          <div className="mb-3">
            ...
            <textarea
              rows={3}
              placeholder="explain about the projects and keep it simple..."
          ...
          <div className="mb-3">
            ...
            <input
              type="text"
              placeholder="Enter your company's contact info"

    ...
    <div className="items-stretch justify-center block w-full min-h-screen p-10 px-10 text-white bg-black lg:flex lg:px-40">
      ...
      <div className="relative w-full lg:w-1/2">
        <img
          src={login}
          alt="Sign In Visual"
          className="object-cover w-full h-full rounded-none lg:rounded-l-3xl"
        />
      </div>
      <div className="flex items-center justify-center w-full px-10 bg-white/10 lg:w-1/2 lg:rounded-r-3xl">
        <div className="w-full">
          <h2 className="mt-3 mb-3 text-2xl font-bold text-center lg:mb-5 lg:mt-5">
            Create an account
          </h2>
          ...
          />
          <button
            className="w-full py-2 my-6 text-white bg-blue-500 rounded-2xl"
          ...
          <p className="my-1 mb-4 text-sm text-center lg:my-3">
